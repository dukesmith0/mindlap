# mindlap
Last refresh: 2026-04-28 | All 7 games playable, profile + leaderboards live, XP+badges autograded. 163 vitest passing across 16 files. typecheck/lint/build clean. Live on `dukesmith0/mindlap` -> Vercel auto-deploy.
